        ...
        <div class="card-body border-bottom py-3">
            <div class="d-flex align-items-center mt-n1 mb-n1">
                <ul class="list-unstyled hstack gap-3 mb-0 font-size-11 flex-grow-1">
                    <li class="fw-bold font-size-13">Compensatory Time Off (HR)</li>
                </ul>
                <div class="hstack gap-2">
                    <ul class="list-inline user-chat-nav text-end dropdown" style="width: 230px; margin-top: -20px; margin-bottom: -20px; margin-right: 20px;">
...
export default {
    ...
    data(){
        return {
            ...
            links: {},
            keyword: '',
            status: (this.auth.data.roles.some(role => role.name === 'Hr Head')) ? 54 : (this.auth.data.roles.some(role => role.name === 'Regional Director') ? 56 : ''),
